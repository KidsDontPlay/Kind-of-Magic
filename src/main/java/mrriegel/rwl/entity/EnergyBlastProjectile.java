...
public class EnergyBlastProjectile extends Entity implements IProjectile,
	...
	public EnergyBlastProjectile(World par1World, double par2, double par4,
			double par6) {
		super(par1World);
		this.setSize(0.5F, 0.5F);
	...
	public EnergyBlastProjectile(World par1World,
			EntityLivingBase par2EntityPlayer, int damage) {
		super(par1World);
	...
	public EnergyBlastProjectile(World par1World,
			EntityLivingBase par2EntityPlayer, int damage, int maxTicksInAir,
			double posX, double posY, double posZ, float rotationYaw,
			float rotationPitch) {
		super(par1World);
		shootingEntity = par2EntityPlayer;
		float par3 = 0.8F;
	...
	public EnergyBlastProjectile(World par1World,
		...
		double d1 = par3EntityLivingBase.boundingBox.minY
				+ (double) (par3EntityLivingBase.height / 1.5F) - this.posY;
	...
	public void writeEntityToNBT(NBTTagCompound par1NBTTagCompound) {
		...
		par1NBTTagCompound
				.setInteger("projectileDamage", this.projectileDamage);
	}
	...
	public void onImpact(MovingObjectPosition mop) {
		if (mop.typeOfHit == MovingObjectPosition.MovingObjectType.ENTITY
			...
			worldObj.createExplosion(shootingEntity, this.posX, this.posY,
					this.posZ, (float) (0.1), true);
			this.setDead();
		}
	}
	...
	public void onImpact(Entity mop) {
		if (mop == shootingEntity && ticksInAir > 3) {
			...
			if (mop instanceof EntityLivingBase) {
				((EntityLivingBase) mop).addPotionEffect(new PotionEffect(
						Potion.weakness.id, 60, 2));
			}
